                  ...
                  <div class='row justify-content-center'>
                    ...
                    <form id="filter-rows-form" class="col-sm-12" style="margin-bottom: 35px;">  
                      <div class="form-row">
                        ...
                        <text-input v-model="filter_rows_form.balance" :error="filter_rows_form.errors.balance" type="number" label="Balance" step="any" id="balance" placeholder="" class="col-sm-4"/>

                        <text-input v-model="filter_rows_form.summary" :error="filter_rows_form.errors.summary" type="text" label="Summary" id="summary" placeholder="" class="col-sm-4"/>
...
export default {
  ...
  watch: {
    filter_rows_form: {
      ...
      handler: throttle(function() {
        this.$inertia.get(this.route('wallet_statement'), pickBy(this.filter_rows_form), { preserveState: true,preserveScroll: true })
      }, 150),
    },
  },
  mounted() {
  ...
  methods: {
    ...
    clearFilterRowsForm() {
      ...
      this.filter_rows_form.balance = "";
      this.filter_rows_form.summary = "";
