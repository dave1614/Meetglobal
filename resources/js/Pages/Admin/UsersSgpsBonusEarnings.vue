          ...
          <div class="row justify-content-center" style="">
            <div class="card" id="main-card">
                ...
                <div class="card-body">
                  ...
                  <h4 class='text-primary' style='font-weight: bold;' v-html="sgps_income"></h4>
                </div>
              </div>
  ...
  watch: {
    filter_rows_form: {
      ...
      handler: throttle(function() {
        this.$inertia.get(this.route('users_sgps_bonus',this.users_user_id), pickBy(this.filter_rows_form), { preserveState: true,preserveScroll: true })
      }, 150),
    },
  },
  mounted() {
