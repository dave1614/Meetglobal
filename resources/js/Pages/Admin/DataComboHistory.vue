...
<template>
    <div class="content">
                  ...
                  <div class='row justify-content-center'>
                    ...
                    <form id="filter-rows-form" class="col-sm-12" style="margin-bottom: 35px;">  
                      <div class="form-row">
                        ...
                        <text-input v-model="filter_rows_form.amount" :error="filter_rows_form.errors.amount" type="text" label="Amount" id="amount" placeholder="" class="col-sm-4"/>
                        ...
                        <text-input v-model="filter_rows_form.credited_date" :error="filter_rows_form.errors.credited_date" type="date" label="Recharged Date" id="credited_date" placeholder="" class="col-sm-4"/>
                    ...
                    <table id="all-registered-users-table" class="table table-test table-striped table-bordered nowrap hover display" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr v-for="row in all_history.data" :key="row.index">
                          ...
                          <td v-html="row.credited_date + ' / ' + row.credited_time"></td>
                        </tr>
      ...
      <div @click="goBackFromDataComboHistory">
...
export default {
  ...
  watch: {
    filter_rows_form: {
      ...
      handler: throttle(function() {
        this.$inertia.get(this.route('data_combo_recharge_history'), pickBy(this.filter_rows_form), { preserveState: true,preserveScroll: true })
      }, 150),
    },
  },
  mounted() {
  ...
  methods: {
    goBackFromDataComboHistory() {
      this.$inertia.visit(this.route('data_combo_requests'));
    ...
    clearFilterRowsForm() {
      ...
      this.filter_rows_form.credited_date = "";
