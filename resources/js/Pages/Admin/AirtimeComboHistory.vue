...
<template>
    <div class="content">
      ...
      <div @click="goBackFromAirtimeComboHistory">
  ...
  watch: {
    filter_rows_form: {
      ...
      handler: throttle(function() {
        this.$inertia.get(this.route('airtime_combo_recharge_history'), pickBy(this.filter_rows_form), { preserveState: true,preserveScroll: true })
      }, 150),
    },
  },
  mounted() {
