                  ...
                  <div class='row justify-content-center'>
                    ...
                    <form id="filter-rows-form" class="col-sm-12" style="margin-bottom: 35px;">  
                      <div class="form-row">
                        ...
                        <text-input v-model="filter_rows_form.user_name" :error="filter_rows_form.errors.user_name" type="text" label="Username" id="user_name" placeholder="" class="col-sm-4"/>

                        <text-input v-model="filter_rows_form.amount_requested" :error="filter_rows_form.errors.amount_requested" type="number" label="Amount Requested" step="any" id="amount_requested" placeholder="" class="col-sm-4"/>

                        <text-input v-model="filter_rows_form.amount_credited" :error="filter_rows_form.errors.amount_credited" type="number" label="Amount Credited" step="any" id="amount_credited" placeholder="" class="col-sm-4"/>

                        <text-input v-model="filter_rows_form.admin_amount" :error="filter_rows_form.errors.admin_amount" type="number" label="Admin Amount" step="any" id="admin_amount" placeholder="" class="col-sm-4"/>
                    ...
                    <table id="all-registered-users-table" class="table table-test table-striped table-bordered nowrap hover display" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr v-for="row in all_requests.data" :key="row.index">
                          ...
                          <td>{{row.amount_credited}}</td>
                          <td>{{row.admin_amount}}</td>
...
export default {
  ...
  watch: {
    filter_rows_form: {
      ...
      handler: throttle(function() {
        this.$inertia.get(this.route('airtime_to_wallet_records'), pickBy(this.filter_rows_form), { preserveState: true,preserveScroll: true })
      }, 150),
    },
  },
  mounted() {
  ...
  methods: {
    ...
    clearFilterRowsForm() {
      ...
      this.filter_rows_form.amount_requested = "";
      this.filter_rows_form.amount_credited = "";
      this.filter_rows_form.admin_amount = "";
