                  ...
                  <div class='row justify-content-center'>
                    ...
                    <form id="filter-rows-form" class="col-sm-12" style="margin-bottom: 35px;">  
                      <div class="form-row">
                        ...
                        <text-input v-model="filter_rows_form.depositors_name" :error="filter_rows_form.errors.depositors_name" type="text" label="Depositors Name" id="depositors_name" placeholder="" class="col-sm-4"/>

                        <text-input v-model="filter_rows_form.credited_amount" :error="filter_rows_form.errors.credited_amount" type="number" step="any" label="Credited Amount" id="credited_amount" placeholder="" class="col-sm-4"/>
                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="form-check form-check-radio form-check-inline">
                            <label class="form-check-label">
                              <input v-model="filter_rows_form.status" class="form-check-input" type="radio" id="credited" value="credited" name="status">
                              Credited
                              <span class="circle">
                                <span class="check"></span>
                              </span>
                        ...
                        <text-input v-model="filter_rows_form.date_of_payment" :error="filter_rows_form.errors.date_of_payment" type="date" label="Date Of Payment" id="date_of_payment" placeholder="" class="col-sm-4"/>
                        ...
                        <text-input v-model="filter_rows_form.credited_date_time" :error="filter_rows_form.errors.credited_date_time" type="date" label="Credited Date" id="date" placeholder="" class="col-sm-4"/>
                    ...
                    <table id="all-registered-users-table" class="table table-test table-striped table-bordered nowrap hover display" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr v-for="request in all_requests.data" :key="request.index">
                          ...
                          <td>{{request.depositors_name}}</td>
                          <td>{{request.status}}</td>
                          <td>{{request.amount_str}}</td>
                          <td>{{request.date_of_payment}}</td>
                          <td>
                            <a target="_blank" :href="'/storage/images/' + request.image" rel="tooltip" title="View Payment Proof" class="btn btn-primary btn-link btn-lg">
                              <i style="font-size: 20px;" class="fas fa-image"></i> 
                              <div class="ripple-container"></div> 
                            </a>
                          </td>
                          <td>{{request.date_time}}</td>
                          <td>{{request.credited_amount_str}}</td>
                          <td>{{request.credited_date_time}}</td>
...
export default {
  ...
  data() {
    return {
      filter_rows_form: this.$inertia.form({
        ...
        depositors_name: this.depositors_name,
        status: this.status,
  ...
  watch: {
    filter_rows_form: {
      ...
      handler: throttle(function() {
        this.$inertia.get(this.route('account_credit_requests'), pickBy(this.filter_rows_form), { preserveState: true,preserveScroll: true })
      }, 150),
    },
  },
  mounted() {
  ...
  methods: {
    ...
    clearFilterRowsForm() {
      ...
      this.filter_rows_form.depositors_name = "";
      this.filter_rows_form.credited_amount = "";
      this.filter_rows_form.date_of_payment = "";
