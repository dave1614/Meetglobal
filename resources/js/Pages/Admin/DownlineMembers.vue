      ...
      <div class="">
        <div class="container-fluid">
          ...
          <div class="row justify-content-center" style="">
            <div class="card col-sm-12" id="downline-info-card">
              <div class="card-body">
                
                <div class="container-fluid">
                  <div class="row">
                    <div class="col-sm-3">
                      <h4 style="font-weight: bold;">Total Downline Members</h4>
                      <p style="font-weight: bold;" class="text-primary" v-html="total_downline_num">{{total_downline_num}}</p>
                    </div>
                    <div class="col-sm-3">
                      <h4 style="font-weight: bold;">Total Levels</h4>
                      <p style="font-weight: bold;" class="text-primary">{{total_levels}}</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div class='row justify-content-center'>
                    ...
                    <form id="filter-rows-form" class="col-sm-12" style="margin-bottom: 35px;">  
                      <div class="form-row">
                        ...
                        <text-input v-model="filter_rows_form.level" :error="filter_rows_form.errors.level" type="number" label="Level" id="level" placeholder="" class="col-sm-4"/>
                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="form-check form-check-radio form-check-inline">
                            <label class="form-check-label">
                              <input v-model="filter_rows_form.package" class="form-check-input" type="radio" id="none" value="none" name="package">
                              None
                              <span class="circle">
                          ...
                          <div class="form-check form-check-radio form-check-inline">
                            <label class="form-check-label">
                              <input v-model="filter_rows_form.package" class="form-check-input" type="radio" id="basic" value="basic" name="package">
                              Basic
                              <span class="circle">
                                <span class="check"></span>
                              </span>
                          ...
                          <div class="form-check form-check-radio form-check-inline">
                            <label class="form-check-label">
                              <input v-model="filter_rows_form.package" class="form-check-input" type="radio" id="business" value="business" name="package"> 
                                Business
                              <span class="circle">
                                <span class="check"></span>
                              </span>
                        ...
                        <text-input v-model="filter_rows_form.date" :error="filter_rows_form.errors.date" type="date" label="Registration Date" id="date" placeholder="" class="col-sm-4"/>
                  ...
                  <div class="table-div material-datatables table-responsive" style="" v-if="all_history.data.length > 0">
                    <table id="all-registered-users-table" class="table table-test table-striped table-bordered nowrap hover display" cellspacing="0" width="100%" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr v-for="request in all_history.data" :key="request.index">
                          <td>{{request.index}}. </td>
                          ...
                          <td><inertia-link class="nav-link" :href="route('user_profile', request.placement_user_slug)">{{request.placement_str}}</inertia-link></td>

                          
                          <td><inertia-link class="nav-link" :href="route('user_profile', request.sponsor_user_slug)">{{request.sponsor_user_name}}</inertia-link></td>

                          <td><em class="text-primary" v-html="request.level_str"></em></td>
                          
                          <td v-html="request.package"></td>
                          <td v-html="request.date_created + ' ' + request.time_created"></td>
                        </tr>
...
export default {
  ...
  props: {
    ...
    start_date: String,
    end_date: String,
    total_downline_num: [Number, String],
    total_levels: [Number, String],
  ...
  watch: {
    filter_rows_form: {
      ...
      handler: throttle(function() {
        this.$inertia.get(this.route('downline_members'), pickBy(this.filter_rows_form), { preserveState: true,preserveScroll: true })
      }, 150),
    },
  },
  mounted() {
  ...
  methods: {
    ...
    clearFilterRowsForm() {
      ...
      this.filter_rows_form.package = "none";
      
      
      this.filter_rows_form.user_name = "";
      this.filter_rows_form.date = "";
      this.filter_rows_form.level = "";
