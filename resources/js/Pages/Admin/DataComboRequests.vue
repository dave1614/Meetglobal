...
<template>
    <div class="content">
      ...
      <div @click="openViewComboRechargeHistoryPage">
        <floating-action-button :styles="'background: 9124a3;'" :title="'View Data Combo Recharge History'">
...
export default {
  ...
  watch: {
    filter_rows_form: {
      ...
      handler: throttle(function() {
        this.$inertia.get(this.route('data_combo_requests'), pickBy(this.filter_rows_form), { preserveState: true,preserveScroll: true })
      }, 150),
    },
  },
  mounted() {
  ...
  methods: {
    openViewComboRechargeHistoryPage() {
      this.$inertia.visit(this.route('data_combo_recharge_history'))
    },
