          ...
          <div class="row justify-content-center" style="">
            <div class="card" id="main-card">
                ...
                <div class="card-body">
                  ...
                  <h4 class='text-primary' style='font-weight: bold;' v-html="'Total Amount: ₦' + addCommas(trade_delivery_income.toFixed(2))"></h4>
...
export default {
  ...
  props: {
    ...
    trade_delivery_income: [Number, String],
  ...
  watch: {
    filter_rows_form: {
      ...
      handler: throttle(function() {
        this.$inertia.get(this.route('view_mlm_earnings_details_trade_delivery'), pickBy(this.filter_rows_form), { preserveState: true,preserveScroll: true })
      }, 150),
    },
  },
  mounted() {
