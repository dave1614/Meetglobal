      ...
      <div class="">
        <div class="container-fluid">
          <div class="text-right">
            <inertia-link as="button" class="btn btn-primary" :href="route('funds_withdrawal')"><i style="font-size: 13px;" class="fas fa-dollar-sign"></i>&nbsp;&nbsp;Withdraw Funds</inertia-link>
  ...
  watch: {
    filter_rows_form: {
      ...
      handler: throttle(function() {
        this.$inertia.get(this.route('funds_withdrawal_history'), pickBy(this.filter_rows_form), { preserveState: true,preserveScroll: true })
      }, 150),
    },
  },
  mounted() {
