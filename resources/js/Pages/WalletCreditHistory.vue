      ...
      <div class="">
        <div class="container-fluid">
          ...
          <div class="text-right">
            <inertia-link as="button" class="btn btn-primary" :href="route('credit_user_wallet')"><i style="font-size: 13px;" class="fas fa-dollar-sign"></i>&nbsp;&nbsp;Credit Wallet</inertia-link>
          </div>
                  ...
                  <div class='row justify-content-center'>
                    ...
                    <form id="filter-rows-form" class="col-sm-12" style="margin-bottom: 35px;">  
                      <div class="form-row">
                        ...
                        <text-input v-model="filter_rows_form.payment_option" :error="filter_rows_form.errors.payment_option" type="text" label="Payment Option" id="payment_option" placeholder="" class="col-sm-4"/>

                        <text-input v-model="filter_rows_form.reference" :error="filter_rows_form.errors.reference" type="text" label="Reference" id="reference" placeholder="" class="col-sm-4"/>
...
export default {
  ...
  watch: {
    filter_rows_form: {
      ...
      handler: throttle(function() {
        this.$inertia.get(this.route('wallet_credit_history'), pickBy(this.filter_rows_form), { preserveState: true,preserveScroll: true })
      }, 150),
    },
  },
  mounted() {
  ...
  methods: {
    ...
    clearFilterRowsForm() {
      ...
      this.filter_rows_form.payment_option = "";
      
      this.filter_rows_form.amount = "";
      this.filter_rows_form.reference = "";
